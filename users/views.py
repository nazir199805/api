...
def create_paypal_order(request):
    ...
    if existing_order and existing_order.paypal_order_id:
        ...
        try:
            ...
            if paypal_response.ok:
                ...
                # -------------------------------------------------
                # If PayPal order is no longer usable, continue
                # and create a new PayPal order.
                # -------------------------------------------------

        except requests.RequestException as e:

            print(
                "Error retrieving existing PayPal order:",
                str(e)
            )
            ...
            print(
                "PayPal returned invalid JSON for existing order."
            )
    ...
    # =========================================================
    # 8. Make sure PayPal returned an order ID
    # =========================================================
...
def capture_paypal_order(request):
    ...
    try:
        ...
        print("======================================")
        print("PAYPAL CAPTURE START")
        print("PayPal Order ID:", order_id)
        ...
        try:
            ...
            print("PAYPAL TOKEN ERROR:", repr(e))
        ...
        try:
            ...
            return Response(
                {
                    "detail": "PayPal returned invalid JSON.",
                    "paypal_status_code": (
                        paypal_response.status_code
                    ),
                    "paypal_response": (
        ...
        try:
            ...
            return Response(
                {
                    "detail": (
                        "Payment was completed by PayPal, "
                        "but the active cart could not be found."
                    ),
                    "order_id": order.id,
                    "paypal_order_id": order_id,
                    "paypal_capture_id": capture_id,
                    "status": "payment_completed_cart_missing",
                },
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
            )
    ...
    # =========================================================
        ...
        print(
            "UNEXPECTED PAYPAL CAPTURE ERROR"
        )
